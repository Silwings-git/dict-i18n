package cn.silwings.dicti18n.declared.impl;
 ...
 * </p>
 */
public class DeclaredDictLoader implements DictI18nLoader, ApplicationContextAware, ApplicationRunner {
    private static final Logger log = LoggerFactory.getLogger(DeclaredDictLoader.class);
    ...
    public DeclaredDictLoader(final DictScanner dictScanner, final DeclaredDictI18nLoaderProperties declaredDictI18nLoaderProperties) {
