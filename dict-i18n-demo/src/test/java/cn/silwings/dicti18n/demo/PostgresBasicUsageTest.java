...
/**
 * Ensure that the application-postgres.yml configuration in the dict-i18n-demo module is correct and that there is an
 * existing PostgresSQL that can be connected to when running this unit test.
 */
...
public class PostgresBasicUsageTest {
