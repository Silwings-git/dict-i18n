...
/**
 * Ensure that the Redis configuration in the dict-i18n-demo module is correct and that there is an accessible
 * Redis available when running the unit test.
 */
...
@SpringBootTest(classes = DemoApplication.class, properties = {
        ...
        "dict-i18n.loader.redis.enabled=true",
        "dict-i18n.loader.sql.enabled=false",
        "dict-i18n.loader.redis.preload.enabled=true",
        "dict-i18n.loader.redis.preload.preload-mode=full"
})
public class RedisBasicUsageTest {
